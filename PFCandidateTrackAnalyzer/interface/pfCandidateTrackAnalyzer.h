#ifndef RecoParticleFlow_PFPatProducer_PFCandidateTrackAnalyzer_
#define RecoParticleFlow_PFPatProducer_PFCandidateTrackAnalyzer_
...
class PFCandidateTrackAnalyzer : public edm::EDAnalyzer {
 public:

  explicit PFCandidateTrackAnalyzer(const edm::ParameterSet&);
