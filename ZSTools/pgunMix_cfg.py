...
ivars.inputFiles = 'file:preMix.root'
...
#Replaced with frontier conditions - Matt
...
process.hiSignal = cms.EDProducer("FlatRandomPtGunProducer",
    ...
    psethack = cms.string('20 pions pt 0. to 200'),
...
def customise(process):
    ...
    process.source.firstRun = cms.untracked.uint32(152602)

#  L1 hack from Camelia to take care of 39X - 42X L1 emulator issue
...
# Modified from default of "PILEUP" -- Matt
process.mixData.SiStripRawDigiSource = cms.string('VirginRaw')
