...
void plotLeadingPhiImBalance_AllCent(){
  ...
  c1->Print("./fig/dijet_leadingPhi_Imbalance_all_cent_20101126_v0.gif");
  c1->Print("./fig/dijet_leadingPhi_Imbalance_all_cent_20101126_v0.eps");
  c1->Print("./fig/dijet_leadingPhi_Imbalance_all_cent_20101126_v0.pdf");
