...
void plotDeltaPhiAllCent(){
  ...
  TLatex *lumi = new TLatex(1.45,0.49,"#intL dt = 3 #mub^{-1}");
  lumi->SetTextFont(63);
  lumi->SetTextSize(15);
  lumi->Draw(); 
		  ...
		  bool drawLeg)
{
  ...
  TH1D *hEmbedded = new TH1D("hEmbedded","",20,0,3.14159);
  ...
  if(drawXLabel) hEmbedded->SetXTitle("#Delta#phi");
  ...
  hEmbedded->SetAxisRange(9E-4,0.9,"Y");
