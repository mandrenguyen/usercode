...
void plotDifferent2ndThreshold(int cbin = 0,
...
void plotDifferent2ndThresholdAllCent(){
  ...
  c1->Print("./fig/Different2ndThreshold_all_cent_20101127_v2.gif");
  c1->Print("./fig/Different2ndThreshold_all_cent_20101127_v2.eps");
  c1->Print("./fig/Different2ndThreshold_all_cent_20101127_v2.pdf");

}

void plotDifferent2ndThreshold(int cbin,
		 TString infname,
		 bool useWeight,
		 bool drawXLabel,
		 bool drawLeg)
