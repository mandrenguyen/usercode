...
void plotDifferent1stThreshold(int cbin = 0,
...
void plotDifferent1stThresholdAllCent(){
  ...
  c1->cd(1);
  plotDifferent1stThreshold(2,"data.root",true,false,false);
  drawText("30-100%",0.75,0.34);
  drawPatch(0.976,0.0972,1.1,0.141);

  c1->cd(2);
  plotDifferent1stThreshold(1,"data.root",true,true,false);
  drawText("10-30%",0.75,0.34);
  drawPatch(-0.00007,0.0972,0.0518,0.141);
  drawPatch(0.976,0.0972,1.1,0.141);

  c1->cd(3);
  plotDifferent1stThreshold(0,"data.root",true,false,true);
  drawText("0-10%",0.75,0.34);
  drawPatch(-0.00007,0.0972,0.0518,0.141);

  TLatex *cms = new TLatex(0.30,3.625,"CMS Preliminary");
  cms->SetTextFont(63);
  cms->SetTextSize(18);
  cms->Draw();                                                                                                                                        

  TLatex *lumi = new TLatex(0.68,3.625,"#intL dt = 3.4 #mub^{-1}");
  lumi->SetTextFont(63);
  lumi->SetTextSize(15);
  lumi->Draw(); 

  c1->Print("./fig/Different1stThreshold_all_cent_20101127_v2.gif");
  c1->Print("./fig/Different1stThreshold_all_cent_20101127_v2.eps");
  c1->Print("./fig/Different1stThreshold_all_cent_20101127_v2.pdf");

}

void plotDifferent1stThreshold(int cbin,
		 TString infname,
		 bool useWeight,
		 bool drawXLabel,
		 bool drawLeg)
{
  ...
  TString cut2="et1>130 && et2>50 && dphi>2.5";
  TString cut3="et1>140 && et2>50 && dphi>2.5";
  TString trigcut1 = "et1>120";
  TString trigcut2 = "et1>130";
  TString trigcut3 = "et1>140";
  ...
  */
  ...
  if(drawLeg){
    ...
    t3->AddEntry(hSys1,"Leading Jet E_{T} > 130 GeV","l");
    t3->AddEntry(hSys2,"Leading Jet E_{T} > 140 GeV","l");
    t3->SetFillColor(0);
    t3->SetBorderSize(0);
    t3->SetFillStyle(0);
    t3->SetTextFont(63);
...
void drawDum(float min, float max, double drawXLabel){
  ...
  hdum->GetYaxis()->SetLabelSize(22);
  hdum->GetYaxis()->SetLabelFont(43);
  hdum->GetYaxis()->SetTitleSize(22);
  hdum->GetYaxis()->SetTitleFont(43);
  hdum->GetYaxis()->SetTitleOffset(2.4);
