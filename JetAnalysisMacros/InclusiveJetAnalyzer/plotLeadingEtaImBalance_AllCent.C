...
void plotLeadingEtaImBalance_AllCent(){
  ...
  cms->SetTextSize(18);
  cms->Draw();                                                                                                                                        
  TLatex *lumi = new TLatex(0.3,2.49,"#intL dt = 7.3 #mub^{-1}");
  lumi->SetTextFont(63);
  lumi->SetTextSize(15);
  lumi->Draw(); 
  ...
  c1->Print("./fig/dijet_leadingEta_imbalance_all_cent_20101126_v0.gif");
  c1->Print("./fig/dijet_leadingEta_imbalance_all_cent_20101126_v0.eps");
  c1->Print("./fig/dijet_leadingEta_imbalance_all_cent_20101126_v0.pdf");
