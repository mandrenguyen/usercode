...
int analyzeJetTreesSys(char *infile="/afs/cern.ch/user/e/edwenger/public/dijets/dijetTreeDM_pt80.root",char *outfile="tmp.root",int
isMC=0, int useWeight=1, int central = 0, int useRawPt = 0, int correctAwaySideJet = 0, int smearEnergy = 0, int simulateIneff = 0)
{
