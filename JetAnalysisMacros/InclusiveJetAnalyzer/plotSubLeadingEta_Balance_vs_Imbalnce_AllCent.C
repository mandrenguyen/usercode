...
void plotSubLeadingEta_Balance_vs_Imbalnce_AllCent() {
  ...
  TLatex *cms = new TLatex(-1.9,1.29,"CMS Preliminary");
  cms->SetTextFont(63);
  cms->SetTextSize(18);
  cms->Draw();
  TLatex *lumi = new TLatex(0.2,1.29,"#intL dt = 3.4 #mub^{-1}");
  lumi->SetTextFont(63);
  lumi->SetTextSize(15);
  lumi->Draw();
  ...
  c1->Print("./fig/dijet_subleadingEta_balance_vs_Imbalance_all_cent_20101126_v0.gif");
  c1->Print("./fig/dijet_subleadingEta_balance_vs_Imbalance_all_cent_20101126_v0.eps");
  c1->Print("./fig/dijet_subleadingEta_balance_vs_Imbalance_all_cent_20101126_v0.pdf");
		      ...
		      int kind)
{
  ...
  TH1D *hBal = new TH1D("hBal","",20,-2.3,2.3);
  TH1D *hImBal = new TH1D("hImBal","",20,-2.3,2.3);
  ...
  if(drawXLabel) hBal->SetXTitle("Subleading jet #eta");
