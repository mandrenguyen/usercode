...
void plotSubLeadingPhi_Balance_vs_Imbalnce_AllCent() {
  ...
  TLatex *mix = new TLatex(-2.5,1.29,"unquenched PYQUEN + Data");
  mix->SetTextFont(63);
  mix->SetTextSize(18);
  mix->Draw();
  ...
  TLatex *hydjet = new TLatex(-2.5,1.29,"unquenched PYQUEN + HYDJET");
  ...
  c1->Print("./fig/dijet_subleadingPhi_balance_vs_Imbalance_all_cent_20101126_v0.gif");
  c1->Print("./fig/dijet_subleadingPhi_balance_vs_Imbalance_all_cent_20101126_v0.eps");
  c1->Print("./fig/dijet_subleadingPhi_balance_vs_Imbalance_all_cent_20101126_v0.pdf");
		      ...
		      int kind)
{
  ...
  if(drawXLabel) hBal->SetXTitle("Subleading jet #phi");
