...
void plotLeadingJetAllCent_onlyBalancedJets(){
  ...
  c1->cd(2);
  plotLeadingJet(1,"data.root","pythia.root","mix.root",true,true,false); gPad->SetLogy();
  ...
  TLatex *lumi = new TLatex(190,1.8,"#intL dt = 7.3 #mub^{-1}");
  lumi->SetTextFont(63);
  lumi->SetTextSize(15);
  lumi->Draw(); 
		    ...
		    bool drawLeg)
{
  ...
  ntPythia->Draw("et1>>hPythia",Form("(%s)",cutpp.Data())); 
