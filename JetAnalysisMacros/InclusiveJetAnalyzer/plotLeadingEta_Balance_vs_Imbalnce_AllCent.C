...
void plotLeadingEta_Balance_vs_Imbalnce_AllCent() {
  ...
  c1->Print("./fig/dijet_leadingEta_balance_vs_Imbalance_all_cent_20101126_v0.gif");
  c1->Print("./fig/dijet_leadingEta_balance_vs_Imbalance_all_cent_20101126_v0.eps");
  c1->Print("./fig/dijet_leadingEta_balance_vs_Imbalance_all_cent_20101126_v0.pdf");
		      ...
		      int kind)
{
  ...
  if(drawXLabel) hBal->SetXTitle("Leading jet #eta");
