...
void weightPtHatBinsBC(int LCB=2){
  ...
  */
  ...
  double bPerEventB[7]={0.,36607./49680.,102616./118430.,82726./85760.,109412./106261.,73373./66255.,57272./49560.};

  double cPerEventQCD[7]={0.,1561./17354.,12423./107431.,3465./26729.,17940./123105.,5459./34457.,6697./39754.};
  double cPerEventC[7]={0.,40941./49680.,85801./93904.,48682./49640.,81423./79440.,51288./47108.,55859./49480.};
  ...
  for (Int_t it=start; it<N; it++) {
    ...
    if(LCB==2 && bPerEventB[it]>0) xSecWeight*=bPerEventQCD[it]/bPerEventB[it];
