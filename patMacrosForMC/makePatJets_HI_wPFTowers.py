...
process.PFJetAnalyzer.writeGenParticles = cms.untracked.bool(False)
...
process.franksAnalyzers = cms.Sequence(process.trkAnalyzer*process.cutsTPForFak*process.cutsTPForEff*process.hitrkEffAnalyzer)
